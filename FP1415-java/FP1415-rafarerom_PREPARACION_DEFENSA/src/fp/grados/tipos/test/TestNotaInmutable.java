...
public class TestNotaInmutable {
	...
	private static void testConstructor1() {
		...
		NotaInmutableImpl nota2 = new NotaInmutableImpl(asig1, 1, Convocatoria.SEGUNDA, 9.00,
				true);
		mostrar(nota2);
	...
	private static void testConstructor1ExcepcionValor() {
		...
		try {
			...
			NotaInmutableImpl nota2 = new NotaInmutableImpl(asig1, 1, Convocatoria.SEGUNDA, 19.00,
					true);
			mostrar(nota2);
	...
	private static void testConstructor1ExcepcionMencionHonor() {
		...
		try {
			...
			NotaInmutableImpl nota2 = new NotaInmutableImpl(asig1, 1, Convocatoria.SEGUNDA, 6.00,
					true);
			mostrar(nota2);
	...
	private static void testConstructor2() {
		...
		NotaInmutableImpl nota1 = new NotaInmutableImpl(asig1, 2014, Convocatoria.SEGUNDA, 6.00);
		mostrar(nota1);
	...
	public static void main(String[] args) {
		...
		Nota nota01= new NotaInmutableImpl("Fundamentos de Programacion#1234567#12.0#ANUAL#1;2014   ;PRIMERA;10.0;true");
